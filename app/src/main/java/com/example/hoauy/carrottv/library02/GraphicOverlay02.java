...
public class GraphicOverlay02 <T extends GraphicOverlay02.Graphic> extends View{
    ...
    public static abstract class Graphic{
        ...
        private GraphicOverlay02 mOverlay;

        public Graphic(GraphicOverlay02 overlay) {
            mOverlay = overlay;
        }
    ...
    public GraphicOverlay02(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
