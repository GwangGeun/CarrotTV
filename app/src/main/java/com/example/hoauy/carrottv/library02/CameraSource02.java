...
public class CameraSource02 {
    ...
    public static class Builder {
        ...
        private CameraSource02 cameraSource = new CameraSource02();
    ...
    public CameraSource02 start() throws IOException {
        synchronized (cameraLock) {
            if (camera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public CameraSource02 start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (cameraLock) {
            if (camera != null) {
                return this;
            }
    ...
    private class PictureDoneCallback implements Camera.PictureCallback {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            synchronized (cameraLock) {
                if (CameraSource02.this.camera != null) {
                    CameraSource02.this.camera.startPreview();
                }
            }
        }
    }
